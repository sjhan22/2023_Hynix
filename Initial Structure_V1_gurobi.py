import sys
sys.path.append("C:/Users/한선진/Desktop/2023_Hynix/Netlist_20230812_함수화.py")
sys.path.append("C:/Users/한선진/Desktop/2023_Hynix/Init_Visualization.py")

# NETLIST_230418_수정.txt
from Netlist_20230812_함수화 import *
...
def solve_placement_opt(timelimit, mipGap, sets, parameters, row_restriction):
    ...
    with gp.Env(empty=True) as env:
        ...
        with gp.Model(env=env) as m:
            ...
            tr = [m.addVar(vtype=GRB.CONTINUOUS, name="tr" + str(k)) for k in range(num_TR)] 
            ...
            for i in C1.keys():
                m.addConstr(
                    sum(psi[i][j] for j in C1.keys() if (i != j) and (((i, j) in II) or ((j, i) in II))) >= phi[i],
                    "c92-" + str(i))
