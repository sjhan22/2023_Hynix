...
def read_netlist(path):
    ...
    return C, C1, C2, B_i, P, SG, WG, G_G, G_I, I_I, SG_SG, SG_O, O_O, TG, revision_TK_i, revision_N, revision_O, revision_TW, revision_PL, revision_ES_i, alpha0, alpha1, alpha2